package com.se7entina.xueshengshuo.view;
...
/**
 * Class: PullZoomListView
 * Created by se7enTina on 2016/2/25.
 * Description: 下拉listview
 */
...
public class PullZoomListView extends ListView {
    ...
    private void init(Context context) {
        ...
        mScreenWidth = metrics.widthPixels;
           /*设置头部View 的初始大小*/
        mHeaderHeight = (int) ((20 * 1.0f / 675) * mScreenWidth);
        ;
